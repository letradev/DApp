...
public class MapActivity extends BaseActivity implements GoogleMap.OnMyLocationButtonClickListener,
    ...
    public void onMyLocationClick(@NonNull Location location) {
        ...
        insertLocation(new LatLng(location.getLatitude(), location.getLongitude()));
    }
    ...
    private void insertLocation(LatLng latLng) {
        mDatabase.child(auth.getCurrentUser().getUid()).setValue(latLng.latitude + "," + latLng.longitude);
    }
}